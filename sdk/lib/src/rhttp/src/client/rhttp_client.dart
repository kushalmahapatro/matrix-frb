...
import 'package:matrix_sdk/src/rhttp/src/model/cancel_token.dart';
...
import 'package:matrix_sdk/src/rhttp/src/request.dart';
...
class RhttpClient {
  ...
  static Future<RhttpClient> create({
    ...
    final interceptor = parseInterceptorList(interceptors);
