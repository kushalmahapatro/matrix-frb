...
import 'package:matrix_sdk/src/rhttp/src/client/io/io_headers.dart';
import 'package:matrix_sdk/src/rhttp/src/client/io/io_response.dart';
...
class RhttpIoRequest implements HttpClientRequest {
  ...
  RhttpIoRequest(this.client, this.method, this.uri);
