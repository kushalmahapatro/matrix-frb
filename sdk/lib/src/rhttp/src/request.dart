...
import 'package:matrix_sdk/src/bindings/lib.dart' as rust_lib;
import 'package:matrix_sdk/src/bindings/rhttp/api/client.dart' as rust_client;
import 'package:matrix_sdk/src/bindings/rhttp/api/error.dart' as rust_error;
import 'package:matrix_sdk/src/bindings/rhttp/api/http.dart' as rust;
import 'package:matrix_sdk/src/bindings/rhttp/api/stream.dart' as rust_stream;
import 'package:matrix_sdk/src/rhttp/rhttp.dart';
import 'package:matrix_sdk/src/rhttp/src/dev_tools.dart';
import 'package:matrix_sdk/src/rhttp/src/model/exception.dart';
import 'package:matrix_sdk/src/rhttp/src/model/request.dart';
import 'package:matrix_sdk/src/rhttp/src/model/response.dart';
import 'package:matrix_sdk/src/rhttp/src/model/settings.dart';
import 'package:matrix_sdk/src/rhttp/src/util/byte_stream_converter.dart';
import 'package:matrix_sdk/src/rhttp/src/util/byte_stream_subscription.dart';
import 'package:matrix_sdk/src/rhttp/src/util/collection.dart';
import 'package:matrix_sdk/src/rhttp/src/util/progress_notifier.dart';
import 'package:matrix_sdk/src/rhttp/src/util/stream_listener.dart';
import 'package:matrix_sdk/src/rhttp/src/util/strings.dart';
  ...
  try {
    if (request.expectBody == HttpExpectBody.stream) {
      ...
      Stream<Uint8List> stream = rust.makeHttpRequestReceiveStream(
        client: request.client?.ref ?? rust_client.getDefaultClientSync(),
