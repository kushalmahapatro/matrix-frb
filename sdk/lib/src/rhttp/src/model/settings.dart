...
export 'package:matrix_sdk/src/bindings/rhttp/api/client.dart' show TlsVersion;
...
extension on TimeoutSettings {
  rust_client.TimeoutSettings _toRustType() {
    return rust_client.TimeoutSettings(
      timeoutMs: timeout != null ? timeout!.inMilliseconds : null,
      connectTimeoutMs: connectTimeout != null ? connectTimeout!.inMilliseconds : null,
      keepAliveTimeoutMs: keepAliveTimeout != null ? keepAliveTimeout!.inMilliseconds : null,
      keepAlivePingMs: keepAlivePing.inMilliseconds,
    );
  }
}
