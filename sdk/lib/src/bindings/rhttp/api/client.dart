...
RequestClient getDefaultClientSync() =>
    RustLib.instance.api.crateRhttpApiClientGetDefaultClientSync();

DnsSettings createStaticResolverSync({required StaticDnsSettings settings}) =>
    RustLib.instance.api.crateRhttpApiClientCreateStaticResolverSync(
      settings: settings,
    );

DnsSettings createDynamicResolverSync({
  required FutureOr<List<String>> Function(String) resolver,
}) => RustLib.instance.api.crateRhttpApiClientCreateDynamicResolverSync(
  resolver: resolver,
);

// Rust type: RustOpaqueNom<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<DnsSettings>>
abstract class DnsSettings implements RustOpaqueInterface {}

// Rust type: RustOpaqueNom<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<RequestClient>>
...
class ClientSettings {
  ...
  static Future<ClientSettings> default_() =>
      RustLib.instance.api.crateRhttpApiClientClientSettingsDefault();
...
class TimeoutSettings {
  ...
  final PlatformInt64? connectTimeoutMs;
  final PlatformInt64? keepAliveTimeoutMs;
  final PlatformInt64? keepAlivePingMs;
  ...
  bool operator ==(Object other) =>
      ...
      other is TimeoutSettings &&
          ...
          keepAlivePingMs == other.keepAlivePingMs;
}
