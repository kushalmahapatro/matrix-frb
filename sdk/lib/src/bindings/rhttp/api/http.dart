...
Future<RequestClient> registerClient({required ClientSettings settings}) =>
    RustLib.instance.api.crateRhttpApiHttpRegisterClient(settings: settings);

RequestClient registerClientSync({required ClientSettings settings}) => RustLib
    .instance
    .api
    .crateRhttpApiHttpRegisterClientSync(settings: settings);

Future<void> cancelRunningRequests({required RequestClient client}) =>
    RustLib.instance.api.crateRhttpApiHttpCancelRunningRequests(client: client);
...
}) => RustLib.instance.api.crateRhttpApiHttpMakeHttpRequest(
  client: client,
  settings: settings,
  method: method,
  url: url,
...
Stream<Uint8List> makeHttpRequestReceiveStream({
  ...
  required FutureOr<void> Function(CancellationToken) onCancelToken,
  required bool cancelable,
}) => RustLib.instance.api.crateRhttpApiHttpMakeHttpRequestReceiveStream(
  client: client,
  settings: settings,
  method: method,
  url: url,
...
Future<void> cancelRequest({required CancellationToken token}) =>
    RustLib.instance.api.crateRhttpApiHttpCancelRequest(token: token);
