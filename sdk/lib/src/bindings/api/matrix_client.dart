...
// These functions are ignored because they are not marked as `pub`: `ensure_sync_notification_handler`, `new`, `sender`, `subscribe`
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `SyncNotificationHub`
...
abstract class MatrixClient implements RustOpaqueInterface {
  ...
  Future<bool> elementCallSendFromWebview({required String json});
  ...
  static Future<void> endCallDeclineWatcherForRtcNotification({
    required String roomId,
    required String rtcNotificationEventId,
  ...
  Future<List<String>> rtcFociLivekitServiceUrls();
  ...
  Future<void> stopElementCallSession();
